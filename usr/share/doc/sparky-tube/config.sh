...
# Se você quiser adicionar ou remover um idioma, basta editar a lista dentro da variável idiomas.

# Dessa forma, fica mais fácil adicionar ou remover idiomas futuramente. 
